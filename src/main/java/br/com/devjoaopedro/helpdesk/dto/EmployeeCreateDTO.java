...
public record EmployeeCreateDTO(
                ...
                @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "dd/MM/yyyy") @Schema(description = "Data de desligamento no formato dd/MM/yyyy", example = "14/02/2026") LocalDate departureDate) {
